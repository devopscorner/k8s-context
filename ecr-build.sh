...
main() {
  # docker_build 0987654321 Dockerfile devopscorner/k8s-context alpine [version|latest|tags] [custom-tags]
  # docker_build 0987654321 Dockerfile.alpine-3.15 devopscorner/k8s-context alpine [version|latest|tags] [custom-tags]
  # docker_build 0987654321 Dockerfile.alpine-3.16 devopscorner/k8s-context alpine [version|latest|tags] [custom-tags]
